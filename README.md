...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/KoHcoJlb/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget -O- https://raw.githubusercontent.com/KoHcoJlb/oh-my-zsh/master/tools/install.sh)"
```
...
```shell
curl -Lo install.sh https://raw.githubusercontent.com/KoHcoJlb/oh-my-zsh/master/tools/install.sh
sh install.sh
```
