...
| Method    | Command                                                                                           |
|:----------|:--------------------------------------------------------------------------------------------------|
| **curl**  | `sh -c "$(curl -fsSL https://raw.githubusercontent.com/KoHcoJlb/ohmyzsh/master/tools/install.sh)"` |
| **wget**  | `sh -c "$(wget -O- https://raw.githubusercontent.com/KoHcoJlb/ohmyzsh/master/tools/install.sh)"`   |
| **fetch** | `sh -c "$(fetch -o - https://raw.githubusercontent.com/KoHcoJlb/ohmyzsh/master/tools/install.sh)"` |
...
```sh
wget https://raw.githubusercontent.com/KoHcoJlb/ohmyzsh/master/tools/install.sh
sh install.sh
```
...
```sh
sh -c "$(curl -fsSL https://raw.githubusercontent.com/KoHcoJlb/oh-my-zsh/master/tools/install.sh)" "" --unattended
```
...
```sh
git clone https://github.com/KoHcoJlb/oh-my-zsh.git ~/.oh-my-zsh
```
